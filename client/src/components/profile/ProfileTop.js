        ...
        <div className="profile-top bg-primary p-2">
            ...
            <div className="icons my-1">
                ...
                {social && social[0].facebook && (
                    <a href={social[0].facebook} target="_blank" rel="noopener noreferrer">
                        <i className="fab fa-facebook fa-2x"></i>
                    </a>
                )}
                {social && social[0].linkedin && (
                    <a href={social[0].linkedin} target="_blank" rel="noopener noreferrer">
                ...
                {social && social[0].instagram && (
                    <a href={social[0].instagram} target="_blank" rel="noopener noreferrer">
